...
describe '.process' do
  ...
  it 'Расстановка дефиса перед -ка, -де, -кась' do
    text = 'Возьми ка детка молока.  А коль увижу де, что казнь ему мала, повешу тут же всех судей вокруг стола. Поди кась так.'
    text_processed = '<nobr>Возьми-ка</nobr> детка молока. А&nbsp;коль <nobr>увижу-де</nobr>, что казнь ему мала, повешу тут&nbsp;же всех судей вокруг стола. <nobr>Поди-кась</nobr> так.'
    Typograph.process(text, OPT).should eq text_processed
  end
  ...
  it 'Не трогам отсупы у тире, если с тире начинается строка' do
    ...
    text_processed = "Правах человека в&nbsp;России, и&nbsp;о&nbsp;ее месте в&nbsp;Совете Европы, и&nbsp;о&nbsp;коллективной памяти о&nbsp;преступлениях Советской власти.\nТатьяна Добровольская\n-------\n**— Где и&nbsp;чему ты учишься, как&nbsp;давно?**— Сейчас я&nbsp;учусь по&nbsp;обмену в&nbsp;Болонском университете на&nbsp;факультете политических наук. В&nbsp;Москве&nbsp;— в&nbsp;Высшей школе экономики"
    Typograph.process(text, OPT).should eq text_processed
  end
end
